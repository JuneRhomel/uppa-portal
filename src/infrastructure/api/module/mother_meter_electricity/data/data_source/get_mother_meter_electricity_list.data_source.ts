...
import GetMotherMeterElectricityListDataSourceParams from "./interface/get_mother_meter_electricity_list_data_source.params";

export default async function GetMotherMeterElectricityListDataSource({ paginationModel }: GetMotherMeterElectricityListDataSourceParams)
