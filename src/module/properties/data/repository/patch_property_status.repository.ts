...
export default async function PatchPropertyStatusRepository({
    ...
    try {
        const propertyStatusModel = new PropertyStatusModel(
            ...
            propertyStatusEntity.created_at,
            propertyStatusEntity.updated_at,
            propertyStatusEntity.deleted_at,
            propertyStatusEntity.deleted_by,
            propertyStatusEntity.updated_by
        );
