...
import GetMotherMeterWaterDataSourceParams from "./interface/get_mother_meter_water_data_source.params";

export default async function GetMotherMeterWaterDataSource({ paginationModel }: GetMotherMeterWaterDataSourceParams): Promise<MotherMeterWaterListModel | Failure> {
    try {
